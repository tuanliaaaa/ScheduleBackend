...
public class AssigmentServiceImpl implements AssigmentService {
    ...
    public List<AssignmentOfUserResponse> getAssignmentOfUser(Integer idTeam){
        ...
        for (AssigmentUser assigmentUser : assigmentUserList){
            ...
            assignmentResponse.setNameAssignment(assigment.getNameAssignment());
    ...
    public AssignmentResponse getAssignmentById(Integer idAssigment) {
        ...
        assignmentResponse.setAssingmentName(assigmentUserList.get(0).getAssigment().getNameAssignment());
    ...
    public List<AssignmentResponse> getAllAssignmentInTeam(Integer idTeam) {
        ...
        for (Assigment assigment : assigments){
            response.add(new AssignmentResponse(assigment.getIdAssigment(), assigment.getNameAssignment(),
                    assigment.getStartAt(), assigment.getEndAt(), assigment.getDescription(), null,assigment.getNameAssignment(),null));
        }
        return response;
    }
}
